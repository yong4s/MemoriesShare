...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": env.str(
        "SECRET_KEY", default="ek12k!Kkwk1e2kdkskqkNDNhw278AB@)3nas"
    ),
    "VERIFYING_KEY": None,
    "AUDIENCE": None,
...
SIMPLE_JWT_SECRET_KEY = env.str(
    "SIMPLE_JWT_SECRET_KEY", default="dev-jwt-secret-key-change-in-production"
)
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", default="MediaFlow <noreply@mediaflow.com>"
)
