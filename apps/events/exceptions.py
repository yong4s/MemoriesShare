...
class EventNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, event_identifier: str | None = None, **kwargs):
...
class EventPermissionError(PermissionError):
    ...
    def __init__(self, action: str | None = None, event_id: str | None = None, **kwargs):
...
class EventBusinessRuleError(BusinessRuleViolation):
    ...
    def __init__(self, rule_name: str, details: str | None = None, **kwargs):
...
class ParticipantNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, participant_identifier: str | None = None, **kwargs):
...
class DuplicateParticipantError(ParticipantError):
    ...
    def __init__(self, user_identifier: str | None = None, **kwargs):
        reason = (
