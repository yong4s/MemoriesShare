...
urlpatterns = [
    ...
    path(
        "create/", EventCreateAPIView.as_view(), name="event-create"
    ),  # POST /events/create/
    path(
        "<uuid:event_uuid>/", EventDetailAPIView.as_view(), name="event-detail"
    ),  # GET /events/{uuid}/
    path(
        "<uuid:event_uuid>/update/", EventUpdateAPIView.as_view(), name="event-update"
    ),  # PUT /events/{uuid}/update/
    path(
    ...
    # User's Own RSVP
    path(
        "<uuid:event_uuid>/rsvp/", MyEventRSVPAPIView.as_view(), name="my-event-rsvp"
    ),  # GET, PATCH
    # Analytics
    path(
