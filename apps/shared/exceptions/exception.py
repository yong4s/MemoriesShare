"""
Infrastructure-level exceptions for shared utilities.

Following Clean Architecture principles, these exceptions are for
cross-cutting concerns that are not specific to any business domain.
"""
